...
bp.Sex_Length <- ggplot(abalone_data, aes(x=Sex, y=Length, fill=Sex, group=Sex)) +
...
bp.Sex_Diameter <- ggplot(abalone_data, aes(x=Sex, y=Diameter, fill=Sex, group=Sex)) +
         geom_boxplot(outlier.shape=8, outlier.color='red') +
         theme(plot.title = element_text(hjust = 0.5),
         panel.background = element_blank(),
         panel.border = element_rect(fill = NA),
...
bp.Sex_Height <- ggplot(abalone_data, aes(x=Sex, y=Height, fill=Sex, group=Sex)) +
         geom_boxplot(outlier.shape=8, outlier.color='red') +
         theme(plot.title = element_text(hjust = 0.5),
         panel.background = element_blank(),
         panel.border = element_rect(fill = NA),
